    ...
    const handleExport = async () => {
        ...
        try {
            ...
            if (blob) {
                ...
                link.href = url;
                link.download = `Onboarding_Forms_${employeeData.personal.employeeId}.pdf`;
                link.click();
        ...
        <div className="bg-page">
            <div className="max-w-4xl p-4 sm:p-6 lg:p-8">
                ...
                <div className="bg-white rounded-xl border border-border shadow-lg p-12 text-center">
                    <p className="text-gray-500 italic">The official forms are ready for download or confirmation.</p>
                </div>
            </div>
        </div>
    );
